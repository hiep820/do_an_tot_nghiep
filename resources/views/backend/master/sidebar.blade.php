<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<form role="search">
            ...
            <li><a href="/admin/attributes"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Attributes</a></li>
			<li><a href="/admin/order"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Đơn hàng</a></li>
			<li role="presentation" class="divider"></li>
            @can('is-admin')
			<li id="qltv"><a href="/admin/user"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Quản lý thành viên</a></li>
            @endcan
		</ul>
