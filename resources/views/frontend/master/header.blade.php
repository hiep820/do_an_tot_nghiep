		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
						<div id="colorlib-logo" style="width: 300px;height: 50px; font-size: 20px;" >Hiệp PR</div>	{{-- <div id="colorlib-logo"><a href="/"><img src="images/logo.png" alt="" style="width: 300px;height: 50px;"></a></div> --}}
						</div>
								...
								<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
									<div class="slider-text-inner">
										<div class="desc">
											...
											<p><a href="/contact" class="btn btn-primary">Kết nối với shop</a></p>
										</div>
									</div>
								</div>
							</div>
